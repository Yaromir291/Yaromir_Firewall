...
namespace Yaromir_Firewall_FINAL1
{
    public class FirewallService
    {
        ...
        public void BlockProgram(string exeName, bool killRunning)
        {
            ...
            // Удаляем из белого списка, если там была
        ...
        /// <summary>
        /// Разблокирует программу: удаляет из чёрного списка, удаляет правила firewall, убивает процессы.
        /// </summary>
        ...
        /// <summary>
        /// Проверяет, есть ли программа в чёрном списке или заблокирована правилами.
        /// </summary>
        public bool IsBlocked(string exeName)
        {
            ...
            // Проверяем, есть ли правила в firewall
