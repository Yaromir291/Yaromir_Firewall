...
{
    /// <summary>
    /// Централизованная локализация приложения (RU/EN).
    /// Все окна подписываются на LanguageChanged и перечитывают строки.
    /// </summary>
    public static class Localization
    {
        ...
        /// <summary>Получить строку по ключу на текущем языке.</summary>
        ...
        /// <summary>Получить строку с подстановкой {0}, {1}...</summary>
